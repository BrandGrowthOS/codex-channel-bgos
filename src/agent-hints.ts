...
A picture you make with image generation posts itself to the chat when the
turn finishes, with its prompt as the caption; do not send it again with MEDIA:
or the reply tool.

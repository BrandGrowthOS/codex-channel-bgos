...
# confirms the real item (result bytes and their form, revisedPrompt,
# savedPath, the failure shape; probe.md, decision 7). Promoting an older
# version after 0.14.0 moves latest back to that older version:
